...
Item {
    ...
    StyledSlider {
        ...
        progressColor: root.hasArtwork && root.playerColors ? root.playerColors.primary : Colors.primaryFixed
        backgroundColor: root.hasArtwork && root.playerColors ? root.playerColors.shadow : Colors.shadow
        wavy: true
